class SingersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @singer.save
        format.html { redirect_to @singer, notice: 'El cantante fue creado!' }
  ...
  def update
    respond_to do |format|
      if @singer.update(singer_params)
        format.html { redirect_to @singer, notice: 'El cantante fue actualizado!' }
  ...
  def destroy
    @singer.destroy
    respond_to do |format|
      format.html { redirect_to singers_url, notice: 'El cantante fue eliminado!' }
  ...
  private
    ...
    def singer_params
      params.require(:singer).permit(:name, :description)
    end
end
