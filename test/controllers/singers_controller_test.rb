...
class SingersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create singer" do
    assert_difference('Singer.count') do
      post singers_url, params: { singer: { description: @singer.description, name: @singer.name } }
    end
  ...
  test "should update singer" do
    patch singer_url(@singer), params: { singer: { description: @singer.description, name: @singer.name } }
