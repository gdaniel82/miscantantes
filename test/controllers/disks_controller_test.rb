...
class DisksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disk" do
    assert_difference('Disk.count') do
      post disks_url, params: { disk: { description: @disk.description, name: @disk.name, singer: @disk.singer } }
    end
  ...
  test "should update disk" do
    patch disk_url(@disk), params: { disk: { description: @disk.description, name: @disk.name, singer: @disk.singer } }
